...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"express-2","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var modules = {};
ms.keys().forEach(function (k) {
  var n = k.substring(2, k.length - 3);
...
/* 13 */
/*!***************************************************!*\
  !*** F:/瓜子/melon/modules sync nonrecursive \.js$ ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var city = {
  ...
  getters: {
    getbaseUserInfo: function getbaseUserInfo(state) {return state.city;}
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var user = {
  ...
  mutations: {
    ...
    removeStatus: function removeStatus(state) {
      state.status = '';
    },
  ...
  getters: {
    getbaseUserInfo: function getbaseUserInfo(state) {return state.user;}
    // getUsername:state=>state.username,
